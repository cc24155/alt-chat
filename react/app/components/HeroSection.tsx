  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-[1200px] mx-auto px-8 flex flex-col items-center text-center gap-8">
        <h1 className="font-title font-normal tracking-[-0.7px] leading-[80%] text-foreground max-w-[900px]">
          {title}
        </h1>
      ...
      {showScroll && (
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
          <span className="font-body tracking-[1.62px] text-foreground uppercase">Scroll</span>
